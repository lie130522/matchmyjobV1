    ...
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col gap-5 mt-8">
          <div>
            <label className="block text-[13px] font-semibold text-[#0F172A] mb-2">{t('jobOfferLabel')} <span className="text-[#EF4444]">*</span></label>
            <textarea
              value={jobOffer}
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="block text-[13px] font-semibold text-[#0F172A]">{t('cvTextLabel')} <span className="text-[#94A3B8] font-normal">(optional but recommended)</span></label>
            ...
            {!cvText && <p className="text-[12px] text-[#94A3B8] mb-2">{t('cvTextHint')}</p>}
          ...
          <div className="flex gap-2">
            ...
            >
              <Zap className="w-4 h-4" fill="white" /> {t('submit')}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col gap-5 mt-8">
          ...
          <div className="flex gap-2">
            ...
            >
              <Zap className="w-4 h-4" fill="white" /> {t('submitGuided')}
            </button>
          </div>
        </div>
      </div>
  ...
  if (step === 'loading') {
    return (
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col items-center justify-center min-h-64 gap-4">
        ...
        <p className="text-[#64748B] text-[15px]">{t('loading')}</p>
      </div>
    )
  }
      ...
      <div className="mt-8 bg-white rounded-2xl border border-[#E2E8F0] overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-[#E2E8F0] bg-[#F8FAFC]">
          <span className="text-[13px] font-medium text-[#64748B]">
            {t('wordCount', { mode: mode === 'auto' ? t('modeAuto') : t('modeGuided'), count: letter.split(/\s+/).length })}
          </span>
          <div className="flex gap-2">
            <button
              onClick={handleCopy}
...
function PageHeader() {
  const t = useTranslations('coverLetter')
  const ta = useTranslations('attempts')
  return (
    <div>
      ...
      <p className="text-[#64748B]">
        ...
        <span className="inline-flex items-center gap-1 text-[#1B4FFF] font-medium text-[13px]">
          <Zap className="w-3 h-3" fill="currentColor" /> {ta('oneAttempt')}
        </span>
      </p>
    </div>
  )
